...
(defclass state ()
 ...
 ;;(defun convert-keycode-to-key (state keycode)
 ;;  (let* ((display (display state))
 ;;         (ch 
 ;;           (xlib:keysym->character
 ;;            display
 ;;            (xlib:keycode->keysym display code
 ;;                                  (xlib:default-keysym-index display code 0)))))
 ;;    (ecase ch
 ;;      (:character-set-switch (error "I dont know what this key is"))
 ...
 ;;      (:left-hyper    :left-hyper)
 ;;      (:right-hyper   :right-hyper)
 ;;      (#\space :space)
 ;;      (#\!)
 ;;      (#\")
 ;;      (#\#)
...
(declaim (ftype (function (state mouse-button) boolean) is-mouse-button-down))
(defun is-mouse-button-down (state button)
  (ecase button
